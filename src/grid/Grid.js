...
export class Grid extends EventEmitter {
    constructor(container = document.body, songOptions, midiData, sound, isEmbed, levelSystem) {
        super()
        ...
        this.instrument = new Instrument(this.el, midiData.instrument, isEmbed, this.levelSystem)
        this.percussion = new Percussion(this.el, midiData.percussion, isEmbed, this.levelSystem)
